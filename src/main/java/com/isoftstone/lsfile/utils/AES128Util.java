...
public class AES128Util
{
    ...
    private static final String KEY_BYTES = "0123456789ABCDEF";
    ...
    private static byte[] encrypt(byte[] content, byte[] KEY_BYTES)
    {
        ...
        */
        Key key = new SecretKeySpec(KEY_BYTES, KEY_ALGORITHM);
        try
        {
            // 用密钥初始化此 cipher。
    ...
    private static byte[] encrypt(String content, String password)
    {
        try
        {
            ...
            Cipher cipher = Cipher.getInstance(DEFAULT_CIPHER_ALGORITHM);//DEFAULT_CIPHER_ALGORITHM          
    ...
    public static byte[] parseHexStr2Byte(String hexStr)
    {
        ...
        for (int i = 0; i < hexStr.length() / 2; i++)
        {
            ...
            int low =
                Integer.parseInt(hexStr.substring(i * 2 + 1, i * 2 + 2), 16);
    ...
    */
    ...
    public static void main(String[] args)
    {
        ...
        String s = AES128Util.encode("12");
        System.out.println(s);
        
        String s1 =
            AES128Util.decode((String)"8D21BB5ADC35A24B9F8EB52CCB46FB6F");
